                                                        ...
                                                        <div class="contact-item">
                                                            ...
                                                            <ul class="contact-phone-list">
                                                                <?php foreach ($contact_info['ua_phone_numbers'] as $phone): ?>
                                                                    <li>
                                                                        <a href="tel:<?= esc_html($phone['phone']); ?>"><?= esc_html($phone['phone']); ?></a>
<!--                                                                        --><?php //= ($phone['show_in_popup']) ? '<span class="popup-indicator">(popup)</span>' : ''; ?>
                                                                    </li>
                                                                <?php endforeach; ?>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <?= ($contact_info['ua_address']) ? '<div class="contact-item"><i class="fa fa-map-marker" aria-hidden="true"></i>' . esc_html($contact_info['ua_address']) . '</div>' : ''; ?>
                                                    <?= ($contact_info['ua_text_information']) ? '<div class="contact-item"><i class="fa fa-info-circle"></i> ' . wp_kses_post($contact_info['ua_text_information']) . '</div>' : ''; ?>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
